...
const CostSavingItem = ({ icon, title, before, after, note }) => (
  <div className="p-4 border-b border-zinc-800 last:border-b-0">
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        ...
        {note && <p className="text-zinc-500 text-xs mt-1">{note}</p>}
      </div>
    </div>
  </div>
);
...
const PlaceholderChart = CorrelationChart; // Alias for backwards compatibility

// ============================================
// MAIN COMPONENT
// ============================================

export default function TradeblockSprintDeck() {
    ...
    <div className="bg-black text-white min-h-screen" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
          ...
          <RevealText delay={0.3}>
            <div className="rounded-xl border border-emerald-500/30 p-5 mb-4" style={{ background: 'rgba(16, 185, 129, 0.05)' }}>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-zinc-500 text-xs">20 campaigns • Jan 8-22</span>
              </div>
          ...
          <RevealText delay={0.4}>
            <div className="rounded-xl border border-blue-500/30 p-5 mb-6" style={{ background: 'rgba(59, 130, 246, 0.05)' }}>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-zinc-500 text-xs">61 targeted campaigns • Dec-Jan</span>
              </div>
      ...
      <Section id="raise" className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <RevealText delay={0.2}>
            <p className="text-xl text-zinc-300 mb-8">
              You've seen the leverage. Now you're seeing the lift.
            </p>
          </RevealText>

          {/* GM Trajectory */}
          <RevealText delay={0.25}>
            <div className="rounded-xl border border-emerald-500/30 p-6 mb-6" style={{ background: 'rgba(16, 185, 129, 0.05)' }}>
              <p className="text-emerald-400 text-xs uppercase tracking-widest mb-4">12-Month GM Trajectory</p>
              <div className="flex items-center justify-center gap-6">
                <div className="text-center">
                  <p className="text-zinc-500 text-xs mb-1">Now</p>
                  <p className="text-2xl font-bold text-zinc-400">$15.6K</p>
                </div>
                <div className="text-zinc-600 text-2xl">→</div>
                <div className="text-center">
                  <p className="text-zinc-500 text-xs mb-1">Dec 2026</p>
                  <p className="text-3xl font-bold text-white">$43.3K</p>
                  <p className="text-emerald-400 text-sm font-medium">+177%</p>
                </div>
              </div>
            </div>
          </RevealText>
          ...
          <RevealText delay={0.3}>
            <div className="rounded-xl border border-zinc-800 p-6 mb-6" style={{ background: 'rgba(24, 24, 27, 0.5)' }}>
              <p className="text-zinc-500 uppercase tracking-widest text-xs mb-4">Where the Capital Goes</p>
              <div className="space-y-4">
                {[
                  { title: 'Runway well past break-even', desc: 'September 2026 and beyond' },
                  { title: 'TradeblockGPT rollout', desc: 'Retention + differentiation' },
                  { title: 'B2B licensing BD', desc: 'Convert inbound interest' },
                  { title: 'Engineering leverage', desc: 'Talent that executes against AI-assisted specs' },
                  { title: 'Flexibility', desc: 'Move when opportunities emerge' },
                ].map((item, i) => (
          ...
          <RevealText delay={0.5}>
            <p className="text-zinc-400 text-center mt-8">
              ...
              <span className="text-white font-medium">every dollar goes further than it ever has.</span>
            </p>
          </RevealText>
        </div>
      </Section>
        ...
        <div className="relative z-10 max-w-2xl text-center mx-auto">
          ...
          <RevealText delay={0.3}>
            <p className="text-zinc-400 mb-8">
              Coming next: <span className="text-white">12-month projections</span>
            </p>
          </RevealText>
          ...
          <RevealText delay={0.5}>
            <p className="text-zinc-500 mb-2">Questions? Let's talk.</p>
            <p className="text-white font-medium text-lg">Mbiyimoh Ghogomu</p>
            <a href="mailto:beems@tradeblock.us" className="text-amber-400 hover:text-amber-300 transition-colors">
              beems@tradeblock.us
            </a>
          </RevealText>
