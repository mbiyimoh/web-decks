...
const EmailVersionCard = ({ version, title, campaign, description, audience, metrics, isHighlighted }) => (
      ...
      <div className="relative">
        ...
        <div className="ml-10 mt-3 border-t border-zinc-800 pt-3">
                ...
                <div className="flex justify-center">
                  {d.push > 0 ? (
                    <motion.div
                      ...
                      style={{ width: `${Math.max(4, Math.min(12, d.push / 2))}px`, height: `${Math.max(4, Math.min(12, d.push / 2))}px` }}
                    />
                  ) : (
                ...
                <div className="flex justify-center">
                  {d.email > 0 ? (
                    <motion.div
                      ...
                      style={{ width: `${Math.max(4, Math.min(10, d.email))}px`, height: `${Math.max(4, Math.min(10, d.email))}px` }}
                    />
                  ) : (
                    <div className="w-1 h-1 rounded-full bg-zinc-800" />
                  )}
          ...
          <div className="flex mt-2">
            <div className="flex-1 text-left"><p className="text-zinc-600 text-xs">Oct</p></div>
            <div className="flex-1 text-center"><p className="text-zinc-600 text-xs">Nov</p></div>
            <div className="flex-1 text-center"><p className="text-zinc-600 text-xs">Dec</p></div>
            <div className="flex-1 text-right"><p className="text-zinc-600 text-xs">Jan</p></div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 pt-4 border-t border-zinc-800 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="text-center">
            ...
            <p className="text-zinc-400 font-bold">~195/wk</p>
          </div>
          <div className="text-amber-400 text-xl">→</div>
          <div className="text-center">
            <p className="text-zinc-500 text-xs">Jan avg</p>
            <p className="text-emerald-400 font-bold">~310/wk</p>
          </div>
          <div className="text-center ml-2">
            <p className="text-emerald-400 font-bold text-lg">+58%</p>
          </div>
        </div>
        <p className="text-zinc-400 text-sm italic">
          Channels light up → transactions climb
        </p>
      </div>
    </motion.div>
  );
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="rounded-xl border border-emerald-500/30 p-4" style={{ background: 'rgba(16, 185, 129, 0.05)' }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-zinc-500 text-xs uppercase">Overall (with debt)</p>
