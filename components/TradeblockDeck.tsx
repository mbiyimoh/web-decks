...
const DemoPlaceholder = ({ title, duration, description }: DemoPlaceholderProps) => {
  const ref = useRef<HTMLDivElement>(null);
  const isInView = useInView(ref, { once: false, margin: "-10%" });
...
// Phase status badge
const PhaseStatus = ({ status }: PhaseStatusProps) => {
  const config = {
...
const Roadmap = ({ activePhase = null }: RoadmapProps) => {
  const phases = [
    { num: 1, title: 'Operator Essentials', desc: 'Back-office AI foundation', status: 'completed' as const },
    { num: 2, title: 'Marketing & Comms', desc: 'Multi-channel automation', status: 'rolling-out' as const },
    { num: 3, title: 'TradeblockGPT', desc: 'Product intelligence', status: 'beta' as const },
  ];
...
const CompanyCard = ({ name, description, delay = 0 }: CompanyCardProps) => {
  const ref = useRef<HTMLDivElement>(null);
  const isInView = useInView(ref, { once: false, margin: "-10%" });
...
const AnalyticsCard = ({ title, value, subtitle, color = 'zinc', delay = 0 }: AnalyticsCardProps) => {
  const ref = useRef<HTMLDivElement>(null);
  const isInView = useInView(ref, { once: false, margin: "-10%" });
          ...
          <RevealText delay={0.2}>
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 mb-12 glow">
              <p className="text-2xl md:text-3xl text-white font-display font-bold leading-relaxed">
                &ldquo;How do we use AI to go from a skeleton crew to operating like a 25-person team—<span className="text-amber-500">without all that headcount spend?</span>&rdquo;
              </p>
            </div>
          </RevealText>
          ...
          <RevealText delay={0.3}>
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 mb-8">
              ...
              <p className="text-zinc-400 mb-6">
                I built connectors for every key data source—accessible through a unified <span className="text-white font-medium">&ldquo;command system&rdquo;</span> that both I and my agents can leverage:
              </p>
            ...
            <RevealText delay={0.2}>
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-white font-medium text-lg mb-2">Define a &ldquo;recipe&rdquo; once</p>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-zinc-900/50 rounded-xl p-5 border border-zinc-800">
                    ...
                    <p className="text-white italic text-lg">&ldquo;Hey, I&apos;m TradeblockGPT. Let&apos;s dial in what you&apos;re looking for.&rdquo;</p>
                  </div>

                  <div className="bg-zinc-900/50 rounded-xl p-5 border border-zinc-800">
                    <p className="text-zinc-500 text-xs uppercase tracking-wider mb-2">→ Surfaces opportunities you&apos;d miss</p>
                    <p className="text-white italic text-lg">&ldquo;There&apos;s a Travis Scott Olive you&apos;ve been sleeping on—the owner wants something you already have.&rdquo;</p>
                  </div>
          ...
          <RevealText delay={0.25}>
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 mb-12 glow">
              <p className="text-2xl text-zinc-200 italic leading-relaxed">
                &ldquo;Let me be one of the first customers the moment this is production-ready. I will pay for it.&rdquo;
              </p>
            ...
            <RevealText delay={0.2}>
              <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-8 h-full">
                ...
                <p className="text-xl text-zinc-500 line-through decoration-zinc-700">
                  &ldquo;Tradeblock is a niche sneaker marketplace trying to survive a tough market.&rdquo;
                </p>
              </div>
            </RevealText>
            ...
            <RevealText delay={0.3}>
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-8 h-full glow">
                ...
                <p className="text-xl text-white">
                  &ldquo;Tradeblock is a capital-efficient, AI-native <span className="text-amber-500">operating system for alternative asset marketplaces</span>—category-agnostic, with defensible IP that other companies already want to license.&rdquo;
                </p>
              </div>
            </RevealText>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            ...
            <RevealText delay={0.3}>
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 h-full">
                ...
                <p className="text-zinc-400">Acquisition interest is warming. We&apos;re now &ldquo;AI-native OS for alternative assets,&rdquo; not &ldquo;struggling marketplace.&rdquo;</p>
              </div>
            </RevealText>
